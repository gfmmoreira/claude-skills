...
name: 1on1-coach
version: 1.0.0
description: "Coach for 1-on-1 meetings. Pre-meeting: translates raw thoughts into professional talking points and challenges assumptions. Post-meeting: captures raw notes into structured summaries that feed future sessions."
argument-hint: "[optional: person name or 'capture' for post-meeting mode]"
